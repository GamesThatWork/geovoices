...
// const cherokeeNav = {
//     title:  choice=> 
//             choice? choice.split(' ').filter( (s,i)=> i<8 ).join(' ')+"..."
//                    : "Cherokee Land and Lore",
//     artist: choice=> 
//             choice?  "Navigator" : "Museum of the Cherokee People",

//     album:   choice=> "Cherokee.GeoVoices.org",
//     artwork: choice=>
//     [
//         {  
//         src: `data:image/jpeg;base64,`,
//         sizes: '60x50', 
//         type: 'image/jpg' 
//         }
//     ]
//     }
 ...
 //             playSilent();
    ...
    const popMetadata =    ()=>   setMetadata(           metaStack.pop()           );
        ...
        // const setMetadata   = choice=>{
        //     const artist = choice=>{
        //         var key  = choice.split('/')[0];
        //         if( key=="story") key = choice.split('/')[1].split('-')[0];
        //         return {
        //             guide:"Stephan Walkingstick w. Shenelle Feather",
        ...
        //             choice.artist? 
        //               choice                    // param is full metadata aobject
        //            :{                           // or param is special name 
        //                 title:  titleCase( choice.split('/').pop().replaceAll('-',' ') ),
        //                 artist: artist( choice ),
        //                 album:  "Cherokee GeoVoices"
        //             });
        //     else alert("no mediasession api")
        //     console.log( navigator.mediaSession.metadata );
        //     }
...
const defer={
    ...
    untilVisible: (medium, content)=>
            false
  //{
        // if( document.visibilityState==="visible" )  return defer.content = false;
        // let  immediate = medium=="speak";// || medium=="text";
        // if( !immediate )    {defer.medium=medium; defer.content=content;}


        // navigator.serviceWorker.getRegistration()
        // .then(  reg => {
        //     if(reg) reg.showNotification( immediate? 
        //           content 
        //         : `There is ${medium} ready.`);
        //     })
    //    }
    }
...
const playSound = src=>    new Promise( (resolve, reject)=> {
    //audioplayer?  audioplayer.dispatchEvent( new Event("ended"));
    audioplayer.src= src;
 // audioplayer.volume = content.volume ?? 1 ;
  ...
  const WINDBACK = 2.1;  
    if( WINDBACK < 0.1 ) return;  

    // when interrupted (eg: by driving directions) wind back 1.5 seconds
    // audioplayer.addEventListener( "pause", ()=>
    //          audioplayer.currentTime >= WINDBACK
    //     &&   audioplayer.currentTime <=(audioplayer.duration-0.5 ) 
    //     && ( audioplayer.currentTime -= WINDBACK ) );

    // when resuming after intterrption, fade in (linear not logarithmic)
    audioplayer.addEventListener('play', () => {
//        if (audioplayer.currentTime < 0.1 ) return; //ie: starting, not resuming
...
const 
    ...
    speak= content=>    new Promise( (resolve, reject)=> {
            if( !content )                              return resolve();
            if( defer.untilVisible("speak", content))   return resolve();
         ...
         //   clear();
            ...
            if( audioplayer ) {
                audioplayer.pause();
                utt.addEventListener( "end", ()=>audioplayer.play() );
                }
...
//            clear();
    ...
    isPlaying = player=> player && (player.speaking || (!player.paused && !player.ended && 0 < player.currentTime)),
